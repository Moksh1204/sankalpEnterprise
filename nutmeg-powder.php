...
<div class="productDetails">
    <section class="page-header category-banner">
        ...
        <div class="container">
            <h1 class="woocommerce-products-header__title">Nutmeg Powder</h1>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-4">
                    <div class="productImg">
                        <img fetchpriority="high" src="./assets/images/product/innerProduct/ground-spices/nutmeg-powder.jpg" />
                    </div>
                </div>
