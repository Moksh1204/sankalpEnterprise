...
<section class="product-section">
    <div class="container">
        <div class="block-title ">
            <p>Our Range of Spices, Grains, and More</p>
            <h3>What We Offer</h3>
        </div>
        <div class="products-listCvr">
            <div class="row">
                ...
                <!-- Ground Spices -->
                <div class="col-sm-12 col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="500ms">
                    <a href="ground-spices.php">
                        <div class="service-one__box">
...
<section class="service-two ">
    <div class="container">
        ...
        <div class="WhyChooseGrid web-why-div">
...
<div class="testimonialSec bgGrey">
    <div class="container">
        <div class="block-title ">
                    ...
                    <div class="swiper-slide">
                        <div class="TestimonialsItem">
                            <div class="contentWrapper">
                                ...
                                <div class="content">
                                    <p>The spices and grains from Sankalp Enterprise are truly exceptional. Fresh aroma, rich taste, and consistent quality make them my first choice.</p>
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="TestimonialsItem">
                            <div class="contentWrapper">
                                ...
                                <div class="content">
                                    <p>I was highly satisfied with the purity of their turmeric and cumin seeds.The packaging was excellent, and the delivery was right on time.</p>
                                </div>
                            </div>
                            <div class="profileWrapper">
                                <div class="profileImg">
                    ...
                    <div class="swiper-slide">
                        <div class="TestimonialsItem">
                            <div class="contentWrapper">
                                ...
                                <div class="content">
                                    <p>From quality to timely delivery, everything is perfect. A dependable partner in the world of spices and grains.</p>
                                </div>
                            </div>
                            <div class="profileWrapper">
                                <div class="profileImg">
