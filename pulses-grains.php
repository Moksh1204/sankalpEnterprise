    ...
    <div class="container">
        ...
        <div class="category-rubric mb-0">
            <div class="term-description test123">
                <h2 class="sub-title"><strong>Sankalp Enterprise Industries – Premium Pulses & Grains from India</strong></h2>
                <p>Sankalp Enterprise Industries is a trusted manufacturer, exporter, and supplier of high-quality pulses and grains. Our range includes Chana Dal, Chickpeas, Mung Beans, Red Lentils, Soya Beans, and Yellow Moong Dal, all carefully cultivated and processed to retain their natural nutrition and flavor.
                    Serving wholesalers, dealers, and distributors across India and worldwide. We deliver unmatched quality and reliability for all your pulses and grains requirements.</p>
